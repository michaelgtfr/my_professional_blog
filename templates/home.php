...
<section class= "presentation row">
    <div class="col-xs-12"> 
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="titlePresentation  col-xs-12" >  
                <p>Je me Présente :</p>
            </div>
            ...
            <div class="blockCV col-sm-3 col-xs-12">  
...
<section class="lastAddition row"> 
    <div class="titleLastAddition col-xs-12">
...
<section class="formContact row">
    ...
    <form action="index.php/contactForm/1" method="post" class="col-xs-12"> 
        <p>
            <div class="col-sm-offset-2 col-sm-3 col-xs-12 form-group">
                <label for="name">Nom : </label><input type="text" class="form-control" id="name" name="name" placeholder="ex: stella" />
            </div>
            <div class="email col-sm-offset-2 col-sm-3 col-xs-12 form-group">
            ...
            <div class="validation col-xs-12 form-group"> 
