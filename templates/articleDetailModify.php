...
<!--body: Detail of the modification of an article-->
	<section class="section container">
		<div class="row">
			<h3 class="titleSection col-xs-12">{{ article.getTitle }}</h3>
			...
			<p class="chapoSection col-xs-12">{{ article.getChapo }}</p>
			<p class="contentSection col-xs-12">{{ article.getContent }}</p>
