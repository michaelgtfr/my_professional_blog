...
<!--body: Page de connexion-->
    ...
    <section class="container">
        <div class="row">
            ...
            <a href="http://projetcinq/index.php/resetpassword" class="resetPassword col-xs-12">Je ne me souviens plus de mon mot de passe</a>
            <a href="http://projetcinq/index.php/registrationpage" class="inscription col-xs-12">Cliquer ici pour s'inscrire</a>
        </div>
    </section>
{% endblock %}
